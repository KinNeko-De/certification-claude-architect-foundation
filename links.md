...
| Topic    | URl     | Tested  | Evaluation
| -------- | ------- | ------- | ------- |
| register to exam | https://anthropic.skilljar.com/claude-certified-architect-foundations-access-request |  ✅ | register page, but there seam to be no public link to it, the courses does not link to it |
| Cookbook by anthropic | https://github.com/anthropics/claude-cookbooks | ❌ | TODO |
| Courses by anthropic | https://github.com/anthropics/courses | ❌ | TODO |
| Playbook by a user | https://drive.google.com/file/d/1luC0rnrET4tDYtS7xe5jUxMDZA-4qNf-/view?usp=sharing | ✅ | Some copy and paste error, content needs to be validated |
